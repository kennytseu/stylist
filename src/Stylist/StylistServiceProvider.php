...
namespace Kennytseu\Stylist;

use Kennytseu\Stylist\Theme\Loader;
use Kennytseu\Stylist\Theme\Stylist;
use Illuminate\Foundation\AliasLoader;
use Kennytseu\Stylist\Html\ThemeHtmlBuilder;
...
class StylistServiceProvider extends AggregateServiceProvider
{
    ...
    private function registerAliases()
    {
        ...
        $aliasLoader->alias('Stylist', 'Kennytseu\Stylist\Facades\StylistFacade');
        $aliasLoader->alias('Theme', 'Kennytseu\Stylist\Facades\ThemeFacade');

        $this->app->alias('stylist', 'Kennytseu\Stylist\Theme\Stylist');
    }
    ...
    {
        $this->commands(
            'Kennytseu\Stylist\Console\PublishAssetsCommand'
        );
    }
